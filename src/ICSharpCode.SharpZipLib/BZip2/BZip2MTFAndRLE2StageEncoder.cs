...
namespace ICSharpCode.SharpZipLib.BZip2
{
	...
	public class BZip2MTFAndRLE2StageEncoder {
		 ...
		 */
		private int[] mtfSymbolFrequencies = new int[BZip2Constants.HUFFMAN_MAXIMUM_ALPHABET_SIZE];
		 ...
		 */
		public ushort[] MtfBlock => mtfBlock;


		/**
		 * @return The actual length of the MTF block
		 */
		public int MtfLength => mtfLength;

		/**
		 * @return The size of the MTF block's alphabet
		 */
		public int MtfAlphabetSize => alphabetSize;

		/**
		 * @return The frequencies of the MTF block's symbols
		 */
		public int[] MtfSymbolFrequencies => mtfSymbolFrequencies;
