...
namespace ICSharpCode.SharpZipLib.BZip2
{
	...
	public class BZip2DivSufSort
	{
		...
		/**
		 */
		private static int STACK_SIZE = 64;

		/**
		 */
		private static int BUCKET_A_SIZE = 256;

		/**
		 */
		private static int BUCKET_B_SIZE = 65536;

		/**
		 */
		private static int SS_BLOCKSIZE = 1024;

		/**
		 */
		private static int INSERTIONSORT_THRESHOLD = 8;

		/**
		 */
		private static int[] log2table = new int[] {
		...
		private void ssMultiKeyIntroSort(int PA, int first, int last, int depth)
		{
			...
			StackEntry[] stack = new StackEntry[STACK_SIZE];
		...
		public int bwt()
		{
			...
			int[] bucketA = new int[BZip2DivSufSort.BUCKET_A_SIZE];
			int[] bucketB = new int[BZip2DivSufSort.BUCKET_B_SIZE];
